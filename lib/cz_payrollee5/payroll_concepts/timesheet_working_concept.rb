module CzPayrollee5
  class TimesheetWorkingConcept < PayrollConcept

    def initialize(article_code, values)
      super(ConceptConstants.REF_TIMESHEET_WORKING, article_code)
      init_values(values)
    end
    ...
    def pending_articles
      [
          TimesheetScheduleArticle.new,
          PositionTermArticle.new
      ]
    end
