...
module CzPayrollee5
  class TypeCategory
    cattr_reader :CALC_CATEGORY_TERMS
    cattr_reader :CALC_CATEGORY_START
    cattr_reader :CALC_CATEGORY_TIMES
    cattr_reader :CALC_CATEGORY_AMOUNT
    cattr_reader :CALC_CATEGORY_GROSS
    cattr_reader :CALC_CATEGORY_NETTO
    cattr_reader :CALC_CATEGORY_FINAL
