...
module CzPayrollee5
  class ConceptConstants
    ...
    REF_SUBJECTS_INS_HEALTH    = Symbolic.new(ConceptCode::CONCEPT_SUBJECTS_INS_HEALTH  , :CONCEPT_SUBJECTS_INS_HEALTH.id2name)
    REF_SUBJECTS_INS_SOCIAL    = Symbolic.new(ConceptCode::CONCEPT_SUBJECTS_INS_SOCIAL  , :CONCEPT_SUBJECTS_INS_SOCIAL.id2name)
    REF_SUBJECTS_SAV_PENSION   = Symbolic.new(ConceptCode::CONCEPT_SUBJECTS_SAV_PENSION , :CONCEPT_SUBJECTS_SAV_PENSION.id2name)
    REF_SUBJECTS_TAX           = Symbolic.new(ConceptCode::CONCEPT_SUBJECTS_TAX         , :CONCEPT_SUBJECTS_TAX.id2name)
    REF_SUBJECTS_TAX_ADVANCE   = Symbolic.new(ConceptCode::CONCEPT_SUBJECTS_TAX_ADVANCE , :CONCEPT_SUBJECTS_TAX_ADVANCE.id2name)
    REF_SUBJECTS_TAX_WITHHOLD  = Symbolic.new(ConceptCode::CONCEPT_SUBJECTS_TAX_WITHHOLD, :CONCEPT_SUBJECTS_TAX_WITHHOLD.id2name)
    ...
    REF_TAX_STATEMENT          = Symbolic.new(ConceptCode::CONCEPT_TAX_STATEMENT        , :CONCEPT_TAX_STATEMENT.id2name)
