module CzPayrollee5
  class PayrollSetup
    ...
    def init_articles
      ...
      load_article(ArticleConstants::REF_SUBJECTS_INS_HEALTH)
      load_article(ArticleConstants::REF_SUBJECTS_INS_SOCIAL)
      load_article(ArticleConstants::REF_SUBJECTS_SAV_PENSION)
      load_article(ArticleConstants::REF_SUBJECTS_TAX)
      load_article(ArticleConstants::REF_SUBJECTS_TAX_ADVANCE)
      load_article(ArticleConstants::REF_SUBJECTS_TAX_WITHHOLD)
      ...
      load_article(ArticleConstants::REF_SAVINGS_PENSION_BASE)
      load_article(ArticleConstants::REF_SAVINGS_PENSION)
      load_article(ArticleConstants::REF_TAX_STATEMENT)
    ...
    def init_concepts
      ...
      load_concept(ConceptConstants::REF_SUBJECTS_INS_HEALTH)
      load_concept(ConceptConstants::REF_SUBJECTS_INS_SOCIAL)
      load_concept(ConceptConstants::REF_SUBJECTS_SAV_PENSION)
      load_concept(ConceptConstants::REF_SUBJECTS_TAX)
      load_concept(ConceptConstants::REF_SUBJECTS_TAX_ADVANCE)
      load_concept(ConceptConstants::REF_SUBJECTS_TAX_WITHHOLD)
      ...
      load_concept(ConceptConstants::REF_SAVINGS_PENSION_BASE)
      load_concept(ConceptConstants::REF_SAVINGS_PENSION)
      load_concept(ConceptConstants::REF_TAX_STATEMENT)
