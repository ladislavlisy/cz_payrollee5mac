require 'rspec'
require 'generate_code/generate_code'
...
describe 'generate articles' do
  ...
  it 'should create classes' do
    constant_article = [
       ...
       'SUBJECTS_INS_HEALTH        ',
       'SUBJECTS_INS_SOCIAL        ',
       'SUBJECTS_SAV_PENSION       ',
       'SUBJECTS_TAX               ',
       'SUBJECTS_TAX_ADVANCE       ',
       'SUBJECTS_TAX_WITHHOLD      ',
    ...
    generator = GenerateCode.new(
        ...
        '/Users/ladislavlisy/DEVX_PAYROLEE5/cz_payrollee5/spec/generate_code/templates/'
    )
    ...
    constant_article.each do |article_constant|
      generator.generate_file(article_constant, 'article_template.rb', '_article.rb',
          ...
          '/Users/ladislavlisy/DEVX_PAYROLEE5/cz_payrollee5/spec/generate_code/outputs/payroll_articles/'
      )
    end
  ...
  it 'should create classes' do
    ...
    constant_concept.each do |concept_constant|
      generator.generate_file(concept_constant, 'concept_template.rb', '_concept.rb',
           ...
           '/Users/ladislavlisy/DEVX_PAYROLEE5/cz_payrollee5/spec/generate_code/outputs/payroll_concepts/'
      )
    end
  ...
  it 'should create classes' do
    ...
    constant_result.each do |result_constant|
      generator.generate_file(result_constant, 'result_template.rb', '_result.rb',
           ...
           '/Users/ladislavlisy/DEVX_PAYROLEE5/cz_payrollee5/spec/generate_code/outputs/payroll_results/'
      )
    end
